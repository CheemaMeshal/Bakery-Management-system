...
class InventoryAdmin:
    def __init__(target,window):
        ...
        labell = Label(Frame1,text="CAKES & BAKES-INVENTORY", background="light pink", font= ("new times roman",25,"bold")).place(x=400, y=25)
        ...
        Table_Frame=Frame(target.window,bd=0, relief=RIDGE,background="light pink")
        Table_Frame.place(x=130,y=270,width=1080,height=430)
        style=ttk.Style(Table_Frame)
        style.configure("Treeview",background="light pink",fieldbackground="light pink",foreground="light pink")
