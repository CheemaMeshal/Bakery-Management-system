...
class BuYuser:
    def __init__(target,window):
        ...
        target.window.title("DayFresh AND BAKES-ONLINE".center(420))  
        ...
        F1 = LabelFrame(target.window,bd=0,relief=GROOVE,background="pink")
        F1.place(x=0,relwidth=2,height=150)

        labelll = Label(F1,text="WELCOME TO CAKES AND BAKES", background="pink", font= ("new times roman",25,"bold")).place(x=400, y=25)
        labelll = Label(F1,text="Time : ", background="pink", font= ("new times roman",15,"bold")).place(x=840, y=65)

        target.labelll_hour = Label(F1,text="12" , fg="black",background="pink",font = ("new times roman", 15))
        target.labelll_hour.place(x=900, y=65)
        
        target.labelll_COLON = Label(F1,text=":" , fg="black",background="pink",font = ("new times roman", 15))
        target.labelll_COLON.place(x=925, y=65)
       
       
        target.labelll_min = Label(F1,text="12" , fg="black",background="pink",font = ("new times roman", 15))
        target.labelll_min.place(x=940, y=65)
       
        target.labelll_COLON = Label(F1,text=":" ,fg="black" ,background="pink",font = ("new times roman",15))
        target.labelll_COLON.place(x=965, y=65)
       
        target.labelll_sec = Label(F1,text="12" ,fg="black", background="pink",font = ("new times roman",15))
        target.labelll_sec.place(x=980, y=65)
        

        target.labelll_abv = Label(F1,text="AM" ,fg="black",background="pink", font = ("new times roman",15))
        ...
        target.ButtonRSF_8 = Button(target.window, relief=GROOVE,bd=0,text="Exit", font=("new times roman",20,"bold"),activebackground="light pink",background="light pink",activeforeground="light pink",fg="black",cursor="hand2", command=target.Exit)
        target.ButtonRSF_8.place(x=15, y=600)
        

        
        Sweets=Label(target.window, text="SWEETS CORNER",font=("new times roman",19,"bold"),background="pink",fg="black")
        ...
        Sweets=Label(target.window, text="DRINKS CORNER",font=("new times roman",19,"bold"),background="pink",fg="black")
        ...
        Sweets=Label(target.window, text="EVERYDAY CORNER",font=("new times roman",19,"bold"),background="pink",fg="black")
        ...
        bill_title=Label(Frame8,text="RECEIPT",font="arial 15 bold",bd=0,background="pink",relief=GROOVE).pack(fill=X)
